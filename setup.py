...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        test_bin = os.path.join(self.build_temp, 'netzwerk_test')
...
setup(
    ...
    description='A hybrid Python/C++ library for modeling networks dynamics',
    long_description='',
    ...
    # and nowhere else
    package_dir={'':'src'},
    # Add an extension module named 'netwerkz' to the package 'netwerkz'
    ext_modules=[CMakeExtension('netzwerk/netzwerk')],
